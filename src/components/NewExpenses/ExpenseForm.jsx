...
const ExpensesForm = (props) => {
    ...
    return <form onSubmit={submitHandler}>
        <div className="new-expense__controls">
            ...
            <div className="new-expense__control">
                <label>Date</label>
                <input type="date" min="2019-01-01" max="2022-12-31" value={userInput.date.toLocaleString('pt-BR',{ year: 'numeric', month: '2-digit', day: '2-digit' })} onChange={dateChangeHandler}/>
            </div>
        </div>
